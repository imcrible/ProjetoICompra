...
public class MainActivity extends AppCompatActivity {
    ...
    private void alertaValidacaoPermissao(){
        ...
        builder.setTitle(R.string.dialog_titulo_permissao_negada);
        builder.setMessage(R.string.dialog_msg_permissao_negada);
        builder.setCancelable(false);
        builder.setPositiveButton(R.string.dialog_botao_confirmar, new DialogInterface.OnClickListener() {
            @Override
